...
if(options.lightBox&&$(this).prop("tagName")==="IMG"){$.fn.mauGallery.methods.openLightBox($(this),options.lightboxId)}else{return}});$(".gallery").on("click",".nav-link",$.fn.mauGallery.methods.filterByTag);$(".gallery").on("keydown",(e)=>{if(!e.target.querySelector(".nav-link"))return;if(e.keyCode===13){e.target.querySelector("span").click()}})
